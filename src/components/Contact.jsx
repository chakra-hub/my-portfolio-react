      ...
      <div className="contact_info">
        ...
        <div className="contact_details">
          <div className="contact_location">
            ...
            <a href="https://goo.gl/maps/4asTGW1AhzmQKoBA9" target='_blank'>Hyderabad, India</a>    
            </div>
          </div>
          <div className="mail">
            ...
            <div className="mail_info cont__info"><a href='mailto:chakrdhrprdhn@gmailcom?subject=Me&body=Hello!'>chkrdhrprdhn@gmail.com</a></div>
          </div>
          <div className="cont_linkein">
            ...
            <div className="cont_linkein_info cont__info"><a href="https://www.linkedin.com/in/chakradhar-pradhan/" target='_blank'>/chakradhar-pradhan</a></div>
          </div>
        </div>
      </div>
